...
public class AdapterSubjects extends RecyclerView.Adapter<AdapterSubjects.ViewHolder> {
    ...
    public AdapterSubjects(Context context, List<UserModel> list, OnItemClick click) {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, @SuppressLint("RecyclerView") final int p) {
        ...
        holder.teacherName.setText(data.getUserName());
        holder.subjectName.setText(data.getTeacherSubject());
