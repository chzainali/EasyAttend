...
import com.example.easyattend.databinding.FragmentEachStudentAttendanceBinding;
...
public class EachStudentAttendanceFragment extends Fragment {
    FragmentEachStudentAttendanceBinding binding;
    ...
    public EachStudentAttendanceFragment() {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            dataModel = (UserModel) getArguments().getSerializable("data");
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        binding = FragmentEachStudentAttendanceBinding.inflate(getLayoutInflater());
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.tvLabel.setText(dataModel.getUserName());
                ...
                if (snapshot.exists()) {
                    ...
                    for (DataSnapshot ds : snapshot.getChildren()) {
                        try {
                            ...
                            if (model.getTeacherId().contentEquals(auth.getCurrentUser().getUid()) && model.getUserId().contentEquals(dataModel.getUserId())) {
