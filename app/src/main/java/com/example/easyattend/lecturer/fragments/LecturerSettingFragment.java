...
import com.example.easyattend.databinding.FragmentLecturerSettingBinding;
...
public class LecturerSettingFragment extends Fragment {
    FragmentLecturerSettingBinding binding;
    Uri imageUri;
    int PICK_IMAGE = 123;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentLecturerSettingBinding.inflate(getLayoutInflater());
