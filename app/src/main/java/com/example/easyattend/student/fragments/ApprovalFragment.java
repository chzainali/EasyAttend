...
public class ApprovalFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentApprovalBinding.inflate(getLayoutInflater());
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.tvApplicationStatus.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Navigation.findNavController(view).navigate(R.id.action_approvalFragment_to_applicationStatusFragment);
            }
        });
                    ...
                    if (snapshot.exists()) {
                        ...
                        if (userModel.getActive().contentEquals("true")) {
                            if (isAlreadyAttempted.contains("false")) {
                                ...
                                Navigation.findNavController(binding.getRoot()).navigate(R.id.action_approvalFragment_to_applyLeaveFragment, bundle);
                            } else {
                                Toast.makeText(requireContext(), "For today leave, you have already applied", Toast.LENGTH_SHORT).show();
                            }
                        } else {
